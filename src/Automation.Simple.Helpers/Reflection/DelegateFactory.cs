...

{
    ...
    using static DelegateHelper;

    /// <summary>
    /// Creates delegates for methods.
    /// </summary>
    public static class DelegateFactory
    {
        ...
        public static Func<object, object[], object> InstanceNonVoidMethod(this Type source,
        ...
        public static Action<object, object[]> InstanceVoidMethod(this Type source, string name, params Type[] paramsTypes)
        {
        ...
        public static Func<object, object[], object> InstanceNonVoidGenericMethod(this Type source,
        ...
        public static Action<object, object[]> InstanceVoidGenericMethod(this Type source,
            string name, Type[] paramsTypes, Type[] typeParams)
        {
        ...
        /// </remarks>
        internal static TDelegate InstanceGenericMethod<TDelegate>(this Type source,
